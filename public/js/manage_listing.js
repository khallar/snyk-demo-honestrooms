...
$http.post('get_description', { lan_code : 'en'}).then(function(response) 
{
     ...
     $scope.lives_house_desc = response.data[0].lives_house_desc;  
     $scope.host_summary = response.data[0].host_summary;  
});
...
$http.post('add_description', {lan_code :lan_code }).then(function(response) 
{
    ...
    $(document).on('change', '[id^="basics-select-"], [id^="select-"]', function() {
        ...
        $http.post('update_rooms', {
            ...
            // if ($scope.beds != '' && $scope.bedrooms != '' && $scope.bed_type != '') {
...
if(current_tab=='en'){
     ...
     */
     $(document).on('click', '[name="services_offer"]', function() {
        var value = '';
        $('[name="services_offer"]').each(function() {
            if ($(this).prop('checked') == true) {
                value = value + $(this).val() + ',';
            }
        });
        ...
        $http.post('update_services_offer', {
            data: value
        }).then(function(response) {
            if (response.data.success == 'true') {
                $('.' + saving_class + ' h5').text('Saved!');
                $('.' + saving_class).fadeOut();
                $scope.status = response.data.status;
                // if (response.data.services_offer != '') {
                //     $('[data-track="service"] a div div .transition').removeClass('visible');
                //     $('[data-track="service"] a div div .transition').addClass('hide');
                //     $('[data-track="service"] a div div div .icon-ok-alt').removeClass('hide');
                // } else {
                //     $('[data-track="service"] a div div .transition').removeClass('hide');
                //     $('[data-track="service"] a div div div .icon-ok-alt').addClass('hide');
                // }
            } else {
                if (response.data.redirect != '' && response.data.redirect != undefined) {
                    window.location = response.data.redirect;
    ...
    /**
     * Update Lives in House 
     * SR_REQUEST_MODIF-11-02-2019
     */

     $(document).on('blur', '[name="lives_house_desc"] ,  [name^="host_summary"]', function() {
            ...
            if (response.data.success == 'true') {
               $('.saving-progress h5').text('Saved!');
                ...
                if (response.data.host != 0) {
                    $('[data-track="host"] a div div .transition').removeClass('visible');
                    $('[data-track="host"] a div div .transition').addClass('hide');
                    $('[data-track="host"] a div div div .icon-ok-alt').removeClass('hide');
                } else {
                    $('[data-track="host"] a div div .transition').removeClass('hide');
                    $('[data-track="host"] a div div div .icon-ok-alt').addClass('hide');
                }
            } else {
     ...
     $(document).on('click', '[name="lives_house"]', function() {
        var value = '';
        $('[name="lives_house"]').each(function() {
            if ($(this).prop('checked') == true) {
                value = value + $(this).val() + ',';
            }
        });
     ...
     $(document).on('click', '[name="speak_language"]', function() {
        var value = '';
        $('[name="speak_language"]').each(function() {
            if ($(this).prop('checked') == true) {
                value = value + $(this).val() + ',';
            }
        });
        ...
        $http.post('update_speak_language', {
            data: value
        }).then(function(response) {
            if (response.data.success == 'true') {
                $('.' + saving_class + ' h5').text('Saved!');
     ...
     // End of lives  house update

     
     /**
     * Update Rule of house customization
     ...
     $(document).on('click', '.rules', function() {
        ...
        $http.post('update_rooms', {
            ...
            if (response.data.success == 'true') {
                ...
                $scope.steps_count = response.data.steps_count;
                 $scope.status = response.data.status;
                if (response.data.rules_house != 0) {
                    $('[data-track="rules"] a div div .transition').removeClass('visible');
                    $('[data-track="rules"] a div div .transition').addClass('hide');
                    $('[data-track="rules"] a div div div .icon-ok-alt').removeClass('hide');
                } else {
                    $('[data-track="rules"] a div div .transition').removeClass('hide');
                    $('[data-track="rules"] a div div div .icon-ok-alt').addClass('hide');
                }
            } else {
                if (response.data.redirect != '' && response.data.redirect != undefined) {
                    window.location = response.data.redirect;
     ...
     */
     $(document).on('click', '.bathroom', function() {
        ...
        if($(this).attr('name') == 'private_bathrooms'){
        ...
        $http.post('update_rooms', {
            ...
            if (response.data.success == 'true') {
                ...
                $scope.steps_count = response.data.steps_count;
                 $scope.status = response.data.status;
                if (response.data.bathrooms != 0) {
                    $('[data-track="bathrooms"] a div div .transition').removeClass('visible');
                    $('[data-track="bathrooms"] a div div .transition').addClass('hide');
                    $('[data-track="bathrooms"] a div div div .icon-ok-alt').removeClass('hide');
                } else {
                    $('[data-track="bathrooms"] a div div .transition').removeClass('hide');
                    $('[data-track="bathrooms"] a div div div .icon-ok-alt').addClass('hide');
                }
            } else {
                if (response.data.redirect != '' && response.data.redirect != undefined) {
                    window.location = response.data.redirect;
    ...
    */
    ...
    $(document).on('change', '[id^="price-select-"]', function() {
        ...
        data_params[$(this).attr('name')] = $(this).val();
        //night price to month price customization update SR_REQUEST_MODIF-12-02-2019
        data_params['month'] = $('#price-month').val();
        ...
        $http.post('update_price', {
            ...
            if (response.data.success == 'true') {
                if(response.data.month_price){
                    $('#price-month').val(response.data.month_price);
                }    
    ...
    $(document).on('blur', '.autosubmit-text[id^="price-"]', function() {
        ...
        if ($('#price-month').val() != 0) {
            ...
            $http.post('update_price', {
                ...
                if ($('#price-month').val() != 0) {
                    $('#price-month-old').val($('#price-month').val());
            ...
            if ($('#price-month-old').val() == 0) {
                $('#price-month').val($('#price-month-old').val());
    ...
    $(document).on('click', '#js-list-space-button', function() {
        ...
        $http.post('update_rooms', {
            ...
            $http.get('rooms_data', {}).then(function(response) {
                ...
                $scope.popup_night = response.data.month;
    ...
    $scope.countSharedSpaceChecks = function() {
        return $(".shared-spaces-checkbox:checked").length;
    };

    $(document).on('click', '.shared-spaces-checkbox', function() {
        var data_params = {};
        var input_name = $(this).attr('name');

        data_params[input_name] = JSON.stringify({
            'kitchen': $scope.shared_spaces_kitchen,
            'living': $scope.shared_spaces_living,
            'dining': $scope.shared_spaces_dining,
            'backyard': $scope.shared_spaces_backyard
        });

        var data = JSON.stringify(data_params);

        $('.saving-progress h5').text('Saving...');
        $('.panel-shared-spaces').fadeIn();
    ...
    $scope.remove_price_rule = function(type, index) {
        ...
        if(item.id != '' && item.id) {
            ...
            $http.post('delete_price_rule/'+item.id, {type:type}).then(function(response){
    ...
    $(document).on('change', '.min_period, .min_discount', function(){
        index = $(this).attr('data-index');
        $scope.update_price_rules('minimum_stay', index);
    });
    $scope.update_price_rules = function(type, index) {
        ...
        // console.log(data);
        if(type == 'minimum_stay') {
        if(data.number_of_month == undefined) {
            return false;
        }
       }else{
