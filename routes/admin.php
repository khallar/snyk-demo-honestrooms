...
Route::group(
    ...
    function () {
        ...
        Route::post('resubmit_listing','Admin\RoomsController@resubmit_listing');
        ...
        Route::get('update_room_status/{id}/{type}/{option}', 'Admin\RoomsController@update_room_status');
        ...
        // Manage Pets Routes
        Route::group(
            ['before' => 'manage_pets', 'middleware' => 'admin_can:manage_pets'],
            function () {
                Route::get('pets', 'Admin\PetsController@index');
                Route::match(array('GET', 'POST'), 'add_pets', 'Admin\PetsController@add');
                Route::match(array('GET', 'POST'), 'edit_pets/{id}', 'Admin\PetsController@update')->where('id', '[0-9]+');
                Route::get('delete_pets/{id}', 'Admin\PetsController@delete')->where('id', '[0-9]+');
                Route::match(array('GET', 'POST'), 'pets_status_check/{id}', 'Admin\PetsController@chck_status')->where('id', '[0-9]+');
            }
        );
        // Manage Services Routes
        Route::group(
            ['before' => 'manage_service', 'middleware' => 'admin_can:manage_service'],
            function () {
                Route::get('service', 'Admin\ServiceController@index');
                Route::match(array('GET', 'POST'), 'add_service', 'Admin\ServiceController@add');
                Route::match(array('GET', 'POST'), 'edit_service/{id}', 'Admin\ServiceController@update')->where('id', '[0-9]+');
                Route::get('delete_service/{id}', 'Admin\ServiceController@delete')->where('id', '[0-9]+');
                Route::match(array('GET', 'POST'), 'service_status_check/{id}', 'Admin\ServiceController@chck_status')->where('id', '[0-9]+');
            }
        );

        // Manage Lives in the house Routes
        Route::group(
            ['before' => 'manage_lives', 'middleware' => 'admin_can:manage_lives'],
            function () {
                Route::get('lives', 'Admin\LivesController@index');
                Route::match(array('GET', 'POST'), 'add_lives', 'Admin\LivesController@add');
                Route::match(array('GET', 'POST'), 'edit_lives/{id}', 'Admin\LivesController@update')->where('id', '[0-9]+');
                Route::get('delete_lives/{id}', 'Admin\LivesController@delete')->where('id', '[0-9]+');
                Route::match(array('GET', 'POST'), 'lives_status_check/{id}', 'Admin\LivesController@chck_status')->where('id', '[0-9]+');
            }
        );
        // Manage Pages Routes
        Route::group(
