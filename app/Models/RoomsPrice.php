...
class RoomsPrice extends Model {
	...
	protected $appends = ['steps_count', 'original_night', 'original_cleaning', 'original_additional_guest', 'original_security', 'original_weekend', 'code','original_month','month_price'];
    ...
    //Customization update SR_REQUEST_MODIF-12-02-2019
...
//return $this->currency_calc('night');
	...
	//Get Month Price
	public function getMonthPriceAttribute(){
		$rental_fee = Fees::find(13)->value;

		$month_price = $this->currency_calc('month');

		$rental_price =  round($month_price * ($rental_fee /100));

		return $month_price + $rental_price;
