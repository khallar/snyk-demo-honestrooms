...
class Rooms extends Model {
	...
	protected $appends = ['steps_count', 'property_type_name', 'room_type_name', 'bed_type_name', 'photo_name', 'host_name', 'reviews_count', 'overall_star_rating', 'reviews_count_lang', 'bed_lang','available_date_format','available_date_mdy'];
	...
	public function availability() {
		return $this->hasMany('App\Models\RoomsAvailability', 'room_id', 'id');
	}
	...
	public static function getMonthAvailability($keep_keys = false){
        ...
        if (!$keep_keys) {
        	$year_month = array_values($year_month);
        }
        return $year_month;
	}
	...
	public static function getAvailabilityRulesMonthsOptions() {
	 ...
	 public function getAvailableDateFormatAttribute(){

	 return date(PHP_DATE_FORMAT, strtotime($this->attributes['available_date']));
	 	
	 }

	 public function getAvailableDateMdyAttribute(){

	 return date('F d, Y', strtotime($this->attributes['available_date']));
