...
class ReservationController extends Controller
{
    ...
    public function host_cancel_reservation(Request $request,EmailController $email_controller)
    {
        ...
        //checkin before 30 days to refund 100% rental refund payment

        $host_fee =0;

        if($interval >= 30){

            $guest_refundable_amount = $reservation_details->rental_prepayment;

            $host_payout_amount = 0;

        }else{

             //checkin in 30 days to no refund
