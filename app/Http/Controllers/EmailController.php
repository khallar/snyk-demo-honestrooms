...
class EmailController extends Controller
{
    ...
    /**
     * Waiting Email send to Admin
     *
     * @param array $room_id, $content
     * @return true
     */
    public function approve_email_admin($room_id){
        ...
        $data['first_name'] = $data['admin']->username;
        $data['created_time'] =$result->created_time;
        $data['subject'] = trans('messages.new_rooms.awaiting_approval',[], null,  $data['locale']);

        $data['view_file'] = 'emails.approve_email_admin';
    ...
    /**
     * Waiting Email send to Host
     *
     * @param array $room_id, $content
     * @return true
     */
    public function approve_email_host($room_id){
        ...
        $data['first_name'] = $user->first_name;
        $data['created_time'] =$result->created_time;
        $data['subject'] = trans('messages.new_rooms.awaiting_approval_host',[], null,  $data['locale']);

        $data['view_file'] = 'emails.approve_email_host';
    ...
    /**
     * Admin Approve to send email to host
     *
     * @param array $room_id
     * @return true
     */
    public function admin_approve_email_host($room_id){
        ...
        $data['view_file'] = 'emails.admin_approve_email_host';
        Mail::to($user->email, $user->first_name)->queue(new MailQueue($data));
