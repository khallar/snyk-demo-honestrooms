...
class RoomsDataTable extends DataTable
{
    ...
    public function ajax()
    {
        ...
        return $this->datatables
            ...
            ->addColumn('verified', function ($rooms) {  
                ...
                $verified =  '<select class="admin_rooms form-control" data-type="verified" id="'.$rooms->room_id.'">
               <option value="Pending" '.($rooms->verified == 'Pending' ? ' selected="selected"' : '').' '.($rooms->verified == 'Resubmit' || $rooms->verified == 'Approve'  ? 'disabled' :'').'>Pending</option>
               <option value="Approve" '.($rooms->verified == 'Resubmit' ? 'disabled' :'') .' '.($rooms->verified == 'Approve' ? ' selected="selected"' : '').' >'.($rooms->verified == 'Approve' ? 'Approved' :'Approve') .'</option>
    ...
    public function html()
    {
        ...
        ->addColumn(['data' => 'verified', 'name' => 'verified', 'title' => 'Verified', 'exportable' => false, 'printable'=>false])
