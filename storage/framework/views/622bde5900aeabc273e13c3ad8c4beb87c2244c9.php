...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=<?php echo e($map_key); ?>&libraries=places&language=<?php echo e((Session::get('language')) ? Session::get('language') : $default_language[0]->value); ?>"></script>
...
<?php echo Html::script('js/mcustom.js'); ?>
...
<?php echo Html::script('js/jquery.sticky-sidebar-scroll.min.js'); ?>

<?php echo Html::script('js/jquery.selectBoxIt.js'); ?>
...
<?php echo Html::script('js/lightgallery-all.min.js'); ?>

<?php echo Html::script('js/lightslider.min.js'); ?>
...
<script> 
  ...
  var LANGUAGE_CODE = "<?php echo (Session::get('language')) ? Session::get('language') : $default_language[0]->value; ?>";
  var USER_ID = <?php echo @Auth::user()->id ? @Auth::user()->id : json_encode([]); ?>;
    // set Inbox Count Globally 
    var inbox_count = <?php echo @Auth::user()->id ? @Auth::user()->inbox_count() : 0; ?>;
    var more_text_lang = "<?php echo e(trans('messages.profile.more')); ?>";
    var validation_messages  = <?php echo json_encode(trans('validation')); ?>;
    var please_set_location = "<?php echo e(trans('messages.home.please_set_location')); ?>";
  ...
  <?php echo Html::script('js/nouislider.min.js?v='.$version); ?>

  <?php echo Html::script('js/jquery.textfill.min.js?v='.$version); ?>  
  <?php echo Html::script('js/mcustom.js?v='.$version); ?>  
  <?php echo Html::script('js/jquery.bxslider.js'); ?>  
  <?php if(!isset($exception)): ?>
  <?php if(Route::current()->uri() == '/'): ?>
  <?php echo Html::script('js/jquery.bxslider.min.js?v='.$version); ?>

  <?php if(@$default_home == 'two'): ?>
  <?php echo Html::script('js/home_two.js'); ?>

  <?php endif; ?>
  <?php endif; ?>       

  <?php if(Route::current()->uri() == 'rooms/new'): ?>
  <?php echo Html::script('js/rooms_new.js?v='.$version); ?>

  <?php echo Html::script('js/home_two.js?v='.$version); ?>

  <?php endif; ?>

  <?php if(Route::current()->uri() == 'manage-listing/{id}/{page}'): ?>
  <?php echo Html::script('js/manage_listing.js?v='.$version); ?>

  <?php echo Html::script('js/home_two.js?v='.$version); ?>

  <?php endif; ?>

  <?php if(Route::current()->uri() == 's'): ?>
  <?php echo Html::script('js/home_two.js?v='.$version); ?>

  <?php echo Html::script('js/infobubble.js'); ?>

  <?php endif; ?>
  <?php if(Route::current()->uri() == 'home_two'): ?>
  ...
  <?php echo Html::script('js/rooms.js?v='.$version); ?>
  ...
  <?php echo Html::script('js/reservation.js?v='.$version); ?>

  <?php endif; ?>

  <?php if(Route::current()->uri() == 'wishlists/popular' || Route::current()->uri() == 'wishlists/my' || Route::current()->uri() == 'wishlists/picks' || Route::current()->uri() == 'wishlists/{id}' || Route::current()->uri() == 'users/{id}/wishlists'): ?>
  <?php echo Html::script('js/wishlists.js?v='.$version); ?>

  <?php echo Html::script('js/home_two.js?v='.$version); ?>

  <?php endif; ?>

  <?php if(Route::current()->uri() == 'inbox' || Route::current()->uri() == 'z/q/{id}' || Route::current()->uri() == 'messaging/qt_with/{id}'): ?>
  <?php echo Html::script('js/inbox.js?v='.$version); ?>

  <?php echo Html::script('js/home_two.js?v='.$version); ?>

  <?php endif; ?>

  <?php if(Route::current()->uri() == 'disputes' || Route::current()->uri() == 'dispute_details/{id}' ): ?>
  <?php echo Html::script('js/disputes.js?v='.$version); ?>
  ...
  <?php endif; ?>
  <?php if(Route::current()->uri() == 'reservation/{id}'): ?>
  <?php echo Html::script('js/reservation.js?v='.$version); ?>
  ...
  <?php echo Html::script('js/host_experiences/owl.carousel.js?v='.$version); ?>

  <?php echo Html::script('js/host_experiences/host_experience.js?v='.$version); ?>
  ...
  <?php if(!empty(Session::get('error_code')) && Session::get('error_code') == 4): ?>
  <script>
    $(function() {
     $('.login_popup').hide();
     $('.signup_popup').hide();
...
<div class="alert cookie-alert alert-dismissible">
  ...
  <p>
<?php echo e(trans('messages.footer.using_cookies',['site_name'=>$site_name])); ?> <a href="<?php echo e(url('/')); ?>/privacy_policy"><?php echo e(trans('messages.login.privacy_policy')); ?>.</a>
  </p>
</div>
