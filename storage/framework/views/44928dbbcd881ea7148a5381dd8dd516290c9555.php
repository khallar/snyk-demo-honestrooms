<?php $__env->startSection('title', trans('messages.install.environment.title')); ?>
<?php $__env->startSection('container'); ?>
    ...
    <form method="post" action="<?php echo e(route('LaravelInstaller::environmentSave')); ?>">
        ...
        <div class="buttons buttons--right">
             <button class="button button--light" type="submit"><?php echo e(trans('messages.install.environment.save')); ?></button>
        </div>
    </form>
