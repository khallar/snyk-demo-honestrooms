      ...
      <div class="panel">
        <div id="discovery-container" class="pad-sm-20" style="float:left;width:100%;">
          <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="no-mar-sm" style="margin-top: 94px;"><div class="textHeaderContainerMarginTop_13o8qr2-o_O-textHeaderContainerWidth_peyti4 row-space-7"><h1 class="textHeader_8yxs9w"><span class="textHeaderTitle_153t78d-o_O-textHeader_rausch_hp6jb4"><?php echo e($site_name); ?> </span><!-- react-text: 7341 --><br>
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 hide-sm">
              <div class="container_e4p5a8"><!-- react-empty: 18439 -->
                <form action="<?php echo e(url('s')); ?>" class="simple-search" method="get" id="searchbar-form" name="simple-search">
                          ...
                          <div>
                            <div class="container_e296pg">
                              <div class="container_36rlri-o_O-block_r99te6">
                                <label class="label_hidden_1m8bb6v" ><?php echo e(trans('messages.header.where')); ?></label>
                                <div class="container_ssgg6h-o_O-container_noMargins_18e9acw-o_O-borderless_mflkgb-o_O-block_r99te6">
                                  <div class="inputContainer_178faes">
                                    ...
                                    id="header-search-form" name="location" placeholder="<?php echo e(trans('messages.header.anywhere')); ?>" value="" type="text">
                                  </div>
                                </div>
                              </div>
                            </div>
                  ...
                  <div data-id="SearchBarSmall" class="container_1tvwao0">
                    <div class="container_mv0xzc" style="width: 100%;">
                      ...
                      <button type="button" class="button_1b5aaxl button-sm-search">
                        ...
                        <span class="copy_14aozyc"><?php echo e(trans('messages.header.anywhere')); ?> · <?php echo e(trans('messages.header.anytime')); ?> · 1 <?php echo e(trans('messages.header.guest')); ?></span></button>
                        ...
                        <div class="body_1sn4o6s-o_O-body_dropdown_7xdft6 arrow-button">
                          <button type="button" class="button_1b5aaxl-o_O-button_border_hu7ym7-o_O-button_large_c3pob4">
                            ...
                            <button type="button" class="button_1b5aaxl-o_O-button_border_hu7ym7-o_O-button_large_c3pob4">
                              ...
                              <span class="copy_14aozyc"><span><span>1 <?php echo e(trans('messages.header.guest')); ?></span></span></span>
                            </button>
                          </div>
                        </div>
                      </div>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12" style="background:#ffffff;">
   <div class="col-md-4 columnn-foot">
    ...
    <div class="textContainer">
      ...
      <div ><span class="content-font">If you need help while traveling or hosting, contact us at our toll free number: <?php echo e($customer_support); ?></span></div>
    </div>
  </div>
</div>
     ...
     <span class="content-font">
      ...
      <span>
       <a href="<?php echo e(url('host_guarantee')); ?>" target="_blank" >
        <!-- react-text: 452 --><?php echo e(trans('messages.search.learn_more')); ?><!-- /react-text -->
      </a>
    </span>
  </span>
</div>
