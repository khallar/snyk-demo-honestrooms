...
<header class="regular-header clearfix hide-sm" id="old-header" role="banner" style="background: none !important;">
    ...
    <a aria-label="Homepage"
        style="background-image: url('http://honestrooms.herokuapp.com/images/logos/logo.png'); position: absolute;height: 100px !important;width: 300px !important;margin-top: -30px;"
        href="{{ url('/') }}"
