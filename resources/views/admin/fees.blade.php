            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="input_service_fee" class="col-sm-3 control-label">Flat Rate</label>
                  <div class="col-sm-7">
                ...
                <div class="form-group">
                  <label for="input_host_fee" class="col-sm-3 control-label">Rental Prepayment</label>
                  <div class="col-sm-7">
                  <div class="input-group input-addon"> 
                    {!! Form::text('rental_prepayment', $result[12]->value, ['class' => 'form-control', 'id' => 'input_rental_prepayment', 'placeholder' => 'Rental Prepayment']) !!}
                    <div class="input-group-addon" style="background-color:#eee;">%</div>
                    <span class="text-danger">{{ $errors->first('rental_prepayment') }}</span>
                  </div>
                  </div>
                </div>
