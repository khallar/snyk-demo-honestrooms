...
<div class="content-wrapper" ng-controller="rooms_admin" ng-init="private_bathroom='{{$result->private_bathrooms}}';">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-header with-border">
                        ...
                        <a href="javascript:void(0);" class="btn btn-warning tab_btn" id="tab_btn_14" ng-click="go_to_edit_step(14)">
                            Service
                        </a>

                         <a href="javascript:void(0);" class="btn btn-warning tab_btn" id="tab_btn_15" ng-click="go_to_edit_step(15)">
                            Host
                        </a>

                        <a href="javascript:void(0);" class="btn btn-warning tab_btn" id="tab_btn_16" ng-click="go_to_edit_step(16)">
                            Rules
                        </a>

                        <a href="javascript:void(0);" class="btn btn-warning tab_btn" id="tab_btn_17" ng-click="go_to_edit_step(17)">
                            Bathrooms
                        </a>
                    ...
                    <!--
                        * update customization in service , host , rules , bathrooms
                     ...
                     <div id="sf14" class="frm">
                       <!--  <p class="text-danger">
                        ...
                        <fieldset class="box-body">
                            <div class="form-group">
                                <label for="country" class="col-sm-3 control-label">
                                    Services you offer to your guest
                                    <!-- <em class="text-danger">
                                        *
                                    </em> -->
                                </label>
                                <div class="col-sm-9">
                                 <ul class="list-unstyled"  id="single" >
                                   
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="checkbox" value="1" name="services_offer[]" {{ in_array('1', $services_offer) ? 'checked' : '' }}>
                                        ...
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="checkbox" value="2" name="services_offer[]" {{ in_array('2', $services_offer) ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   Bed sheets and towels (weekly changed)
                                                </span>
                                            </label>
                                        </li>
                        ...
                        <div class="box-footer">
                            ...
                            <button class="btn btn-info pull-right" type="submit" name="submit" value="services">
                                Submit
                            </button>
                        </div>
                    </div>
                    <div id="sf15" class="frm">
                        ...
                        <fieldset class="box-body">
                             <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea name="lives_house_desc"  class="form-control" id="lives_house_desc" rows="5">{{$result->lives_house_desc}}
                                        </textarea>
                                    </div>
                                </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @foreach($lives_house as $liveshouse)
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="checkbox" value="{{ $liveshouse->id }}" name="lives_house[]" {{ in_array($liveshouse->id, $prev_lives_house) ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                    {{ $liveshouse->name }}
                                                </span>
                                            </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @foreach($speak_language as $speaklanguage)
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="checkbox" value="{{ $speaklanguage->id }}" name="speak_language[]" {{ in_array($speaklanguage->id, $prev_speak_language) ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                    {{ $speaklanguage->name }}
                                                </span>
                                            </label>
                                    ...
                                    <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="checkbox" value="0" name="speak_language[]" {{ in_array('0', $prev_speak_language) ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                    Others
                                                </span>
                                            </label>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                       <ul class="list-unstyled" id="single">
                                    @foreach($pets as $pets_val)
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left pets" type="checkbox" value="{{ $pets_val->id }}" name="pets[]" {{ in_array($pets_val->id, $prev_pets) ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                    {{ $pets_val->name }}
                                                </span>
                                            </label>
                                    ...
                                    <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left pets" type="checkbox" value="0" name="pets[]" {{ in_array('0', $prev_pets) ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   Others
                                                </span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left no_pets" type="checkbox" value="no" name="pets[]" {{ in_array('no', $prev_pets) ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   I have no Pets
                                                </span>
                                            </label>
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea name="summary"  class="form-control" id="summary" rows="5">{{$result->host_summary}}
                                        </textarea>
                                    </div>
                                </div>
                        ...
                        <div class="box-footer">
                            ...
                            <button class="btn btn-info pull-right" type="submit" name="submit" value="host">
                                Submit
                            </button>
                        </div>
                    </div>
                    <div id="sf16" class="frm">
                        ...
                        <fieldset class="box-body">
                            ...
                            <div class="form-group">
                                <label for="country" class="col-sm-3 control-label">
                                    Is it allowed to smoke at your home?
                                    <em class="text-danger">
                                        *
                                    </em>
                                </label>
                                <div class="col-sm-9">
                                   ...
                                   <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="Yes" name="allow_smoke" {{ $result->allow_smoke == 'Yes' ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   Yes
                                                </span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="No" name="allow_smoke" {{ $result->allow_smoke == 'No' ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   No
                                                </span>
                                            </label>
                            ...
                            <div class="form-group">
                                <label for="country" class="col-sm-3 control-label">
                                    Do you accept pets from your guests?
                                    <em class="text-danger">
                                        *
                                    </em>
                                </label>
                                <div class="col-sm-9">
                                   ...
                                   <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="Yes" name="accept_pets" {{ $result->accept_pets == 'Yes' ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   Yes
                                                </span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="No" name="accept_pets" {{ $result->accept_pets == 'No' ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   No
                                                </span>
                                            </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                   ...
                                   <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="Yes" name="invite_visitors" {{ $result->invite_visitors == 'Yes' ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   Yes
                                                </span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="No" name="invite_visitors" {{ $result->invite_visitors == 'No' ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   No
                                                </span>
                                            </label>
                        ...
                        <div class="box-footer">
                            ...
                            <button class="btn btn-info pull-right" type="submit" name="submit" value="rules">
                                Submit
                            </button>
                        </div>
                    </div>
                    <div id="sf17" class="frm">
                        ...
                        <fieldset class="box-body" >
                            ...
                            <div class="form-group">
                                <label for="country" class="col-sm-4 control-label">
                                    Does the room has a private bathroom?
                                    <em class="text-danger">
                                        *
                                    </em>
                                </label>
                                <div class="col-sm-8">
                                   ...
                                   <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left private_bathrooms" type="radio" value="Yes" name="private_bathrooms" {{ $result->private_bathrooms == 'Yes' ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   Yes
                                                </span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left private_bathrooms" type="radio" value="No" name="private_bathrooms" {{ $result->private_bathrooms == 'No' ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   No
                                                </span>
                                            </label>
                            ...
                            <div class="form-group" ng-show="private_bathroom == 'No'">
                                <label for="country" class="col-sm-4 control-label">
                                   If it's a shared bathroom, With how many people it's shared?
                                    <em class="text-danger">
                                        *
                                    </em>
                                </label>
                                <div class="col-sm-8">
                                   ...
                                   <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="{{$i}}" name="bathrooms" {{ $result->bathrooms == $i ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                  {{ ($i == '4') ? $i.'+' : $i }}
                                                </span>
                                            </label>
                        ...
                        <div class="box-footer">
                            ...
                            <button class="btn btn-info pull-right" type="submit" name="submit" value="bathrooms">
                                Submit
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="sf8" class="frm">
                        ...
                        <fieldset class="box-body">
                            <!--
                               * Night Price to Month Price update customization in SR_REQUEST_MODIF-12-02-2019 
                              -->
                            <div class="form-group">
                                <label for="night" class="col-sm-3 control-label">
                                    Month
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @foreach($service as $service_val)
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="checkbox" value="{{ $service_val->id }}" name="service[]" {{ in_array($service_val->id, $prev_service) ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                    {{ $service_val->name }}
                                                </span>
                                            </label>
                    ...
                    <div id="sf9" class="frm">
                        <fieldset class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    {!! Form::select('booking_type', ['request_to_book'=>'Request To Book'], $result->booking_type, ['class' => 'form-control', 'id' => 'booking_type']) !!}
                                </div>
                            </div>
                        </fieldset>
                        <div class="box-footer">
          ...
          <ul>
           ...
           <ul class="list-unstyled" id="single">
                                   <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="Yes" name="cancel_policy_accept" {{ $result->cancel_policy_accept == 'Yes' ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   {{ trans('messages.cancellation_policy.i_accept_the_cancellation') }}
                                                </span>
                                            </label>
                                        </li>
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="No" name="cancel_policy_accept" {{ $result->cancel_policy_accept == 'No' ? 'checked' : '' }}>
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                  {{ trans('messages.cancellation_policy.not_accept_the_cancellation') }}
                                                </span>
                                            </label>
                                        </li>
                                </ul>
                    ...
                    <div id="sf12" class="frm">
                        <fieldset class="box-body">
                             <div class="row availability_rules">
                                <div class="col-md-8 col-md-offset-2 length_of_stay_wrapper" ng-init="length_of_stay_items = {{json_encode($result->availability)}};">
                                    <div class="panel panel-info" ng-init="length_of_stay_options= {{json_encode($availability_month)}}">
                                        <div class="panel-header">
                                            <h4>
                                               Availability Rules
                                            </h4>
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-sm-12 row-space-top-1" ng-repeat="item in length_of_stay_items" ng-if="length_of_stay_option_avaialble_check(item.year_month) != 0">
                                                    <div class="row">
                                                        <input type="hidden" name="length_of_stay[@{{$index}}][id]" value="@{{item.id}}">
                                                        <div class="col-md-4">
                                                            <select name="length_of_stay[@{{$index}}][period]" class="form-control" id="length_of_stay_period_@{{$index}}" ng-model="length_of_stay_items[$index].year_month">
                                                                <option disabled>
                                                                    Select Months
                                                                </option>
                                                        ...
                                                        <div class="col-md-4" id="discount_error_container_@{{$index}}">
                                                            <div class="input-addon">
                                                                <input type="text" name="length_of_stay[@{{$index}}][discount]" class="form-control discount" id="length_of_stay_discount_@{{$index}}" ng-model="length_of_stay_items[$index].number_of_month" placeholder="Minimum Month" data-error-placement="container" data-error-container="#discount_error_container_@{{$index}}">
                                                               <!--  <span class="input-suffix">
                                                                    %
                                                                </span> -->
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <a href="javascript:void(0)" class="btn btn-danger btn-xs" ng-click="remove_price_rule('minimum_stay', $index)">
                                                                <span class="fa fa-trash">
                                                                </span>
                                                            </a>
                                                        </div>
