...
<div class="content-wrapper" ng-controller="rooms_admin" ng-init="add_room_steps();private_bathroom='';" >
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <div class="box-body" ng-cloak>
            ...
            --> 
            <div id="sf14" class="frm" data-step-name="Services">
             
              <fieldset class="box-body">
                <div class="form-group">
                  <label for="country" class="col-sm-3 control-label">Services you offer to your guest<!-- <em class="text-danger">*</em> --></label>
                  <div class="col-sm-9">
                    <ul class="list-unstyled"  id="single" >
                      <li>
                       <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                        <input class="pull-left" type="checkbox" value="1" name="services_offer[]">
                          <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">Weekly cleaning of the room</span>
                       </label>
                      </li>
                      <li>
                        <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                          <input class="pull-left" type="checkbox" value="2" name="services_offer[]" >
                            <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">Bed sheets and towels (weekly changed)</span>
                         </label>
                       </li>     
                    </ul>
                  </div>
            ...
            <div id="sf15" class="frm"  data-step-name="Host">
                        ...
                        <fieldset class="box-body">
                             <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea name="lives_house_desc"  class="form-control" id="lives_house_desc" rows="5">
                                        </textarea>
                                    </div>
                                </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @foreach($lives_house as $liveshouse)
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="checkbox" value="{{ $liveshouse->id }}" name="lives_house[]" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @foreach($speak_language as $speaklanguage)
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="checkbox" value="{{ $speaklanguage->id }}" name="speak_language[]" >
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                    {{ $speaklanguage->name }}
                                                </span>
                                            </label>
                                    ...
                                    <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="checkbox" value="0" name="speak_language[]" >
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                    Others
                                                </span>
                                            </label>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @foreach($pets as $pets_val)
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left pets" type="checkbox" value="{{ $pets_val->id }}" name="pets[]" >
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                    {{ $pets_val->name }}
                                                </span>
                                            </label>
                                    ...
                                    <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left pets" type="checkbox" value="0" name="pets[]">
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   Others
                                                </span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left no_pets" type="checkbox" value="no" name="pets[]" >
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   I have no Pets
                                                </span>
                                            </label>
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea name="summary"  class="form-control" id="summary" rows="5">
                                        </textarea>
                                    </div>
                                </div>
                    ...
                    <div id="sf16" class="frm" data-step-name="Rules">
                        ...
                        <fieldset class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                   ...
                                   <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="Yes" name="allow_smoke">
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   Yes
                                                </span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="No" name="allow_smoke">
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   No
                                                </span>
                                            </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                   ...
                                   <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="Yes" name="accept_pets" >
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   Yes
                                                </span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="No" name="accept_pets">
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   No
                                                </span>
                                            </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                   ...
                                   <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="Yes" name="invite_visitors">
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   Yes
                                                </span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="No" name="invite_visitors">
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   No
                                                </span>
                                            </label>
                    ...
                    <div id="sf17" class="frm" data-step-name="Bathrooms">
                        ...
                        <fieldset class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                   ...
                                   <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left private_bathrooms" type="radio" value="Yes" name="private_bathrooms" >
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   Yes
                                                </span>
                                            </label>
                                        ...
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left private_bathrooms" type="radio" value="No" name="private_bathrooms" >
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                   No
                                                </span>
                                            </label>
                            ...
                            <div class="form-group" ng-show="private_bathroom == 'No'">
                                ...
                                <div class="col-sm-8">
                                   ...
                                   <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="{{$i}}" name="bathrooms">
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                  {{ ($i == '4') ? $i.'+' : $i }}
                                                </span>
                                            </label>
            ...
            <div id="sf8" class="frm" data-step-name="Pricing">
              <fieldset class="box-body">
                <div class="form-group">
                  <label for="night" class="col-sm-3 control-label">Month
                    <em class="text-danger">*
                    </em>
                  </label>
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @foreach($service as $service_val)
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="checkbox" value="{{ $service_val->id }}" name="service[]">
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                                    {{ $service_val->name }}
                                                </span>
                                            </label>
            ...
            <div id="sf9" class="frm" data-step-name="Booking Type">
              <fieldset class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::select('booking_type', ['request_to_book'=>'Request To Book'], 'request_to_book', ['class' => 'form-control', 'id' => 'booking_type']) !!}
                  </div>
                </div>
              </fieldset>
            </div>
          ...
          <ul>
           ...
           <ul class="list-unstyled" id="single">
                                   <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="Yes" name="cancel_policy_accept">
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                                        ...
                                        <li>
                                            <label class="label-large label-inline amenity-label pull-left" style="width:100% !important;">
                                                <input class="pull-left" type="radio" value="No" name="cancel_policy_accept">
                                                <span class="pull-left" style="margin-left:8px;width:85%;white-space:normal;">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-4" id="discount_error_container_@{{$index}}">
                                <div class="input-addon">
                                  <input type="text" name="length_of_stay[@{{$index}}][discount]" class="form-control discount" id="length_of_stay_discount_@{{$index}}" ng-model="length_of_stay_items[$index].discount" placeholder="Minimum Month" data-error-placement="container" data-error-container="#discount_error_container_@{{$index}}">
