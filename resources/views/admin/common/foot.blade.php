...
@if (!isset($exception))
    ...
    @if(Route::current()->uri() == '{ADMIN_URL}/add_property_type' || Route::current()->uri() == '{ADMIN_URL}/edit_property_type/{id}' || Route::current()->uri() == '{ADMIN_URL}/add_room_type' || Route::current()->uri() == '{ADMIN_URL}/edit_room_type/{id}'|| Route::current()->uri() == '{ADMIN_URL}/add_bed_type' || Route::current()->uri() == '{ADMIN_URL}/edit_bed_type/{id}' || Route::current()->uri() == '{ADMIN_URL}/add_amenities_type' || Route::current()->uri() == '{ADMIN_URL}/edit_amenities_type/{id}'|| Route::current()->uri() == '{ADMIN_URL}/add_amenity' || Route::current()->uri() == '{ADMIN_URL}/edit_amenity/{id}' || Route::current()->uri() == '{ADMIN_URL}/add_pets' || Route::current()->uri() == '{ADMIN_URL}/edit_pets/{id}' || Route::current()->uri() == '{ADMIN_URL}/add_service' || Route::current()->uri() == '{ADMIN_URL}/edit_service/{id}' || Route::current()->uri() == '{ADMIN_URL}/add_lives' || Route::current()->uri() == '{ADMIN_URL}/edit_lives/{id}')
    <script src="{{ url('admin_assets/dist/js/jquery.validate.js') }}"></script>
