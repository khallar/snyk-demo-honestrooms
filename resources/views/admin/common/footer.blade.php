        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                              ...
                              <!--   <div class="col-sm-12">
                                <label>Resubmit reason:</label>
                                    </div> -->
                                   
                                <div class="col-sm-12">
                                    {!! Form::textarea('resubmit_msg', '', ['class' => 'form-control  resubmit_msg', 'id' => 'resubmit_msg', 'placeholder' => 'Please enter the reason here', 'rows' => 5]) !!}
                ...
                <div class="modal-footer" style="border-top: 0px solid #e5e5e5;">
                    <button type="button" class="btn btn-default resubmit_listing" data-dismiss="modal">Cancel</button>
