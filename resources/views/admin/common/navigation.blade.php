...
{{--HostExperienceBladeCommentStart
        ...
        @if(Auth::guard('admin')->user()->can('reservations'))
          ...
          <a href="#">
            <i class="fa fa-plane"></i> <span>Reservations </span><i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
       ...
       <!--  <li class="{{ (Route::current()->uri() == ADMIN_URL.'/referrals') ? 'active' : ''  }}"><a href="{{ url(ADMIN_URL.'/referrals') }}"><i class="fa fa-group"></i><span>Referrals</span></a></li> -->
        ...
        @endif -->
         ...
         @if(Auth::guard('admin')->user()->can('manage_pets'))
          <li class="{{ (Route::current()->uri() == ADMIN_URL.'/pets') ? 'active' : ''  }}"><a href="{{ url(ADMIN_URL.'/pets') }}"><i class="fa fa-paw"></i><span>Manage Pets</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_service'))
          <li class="{{ (Route::current()->uri() == ADMIN_URL.'/service') ? 'active' : ''  }}"><a href="{{ url(ADMIN_URL.'/service') }}"><i class="fa fa-bolt"></i><span>Manage Service</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_lives'))
          <li class="{{ (Route::current()->uri() == ADMIN_URL.'/lives') ? 'active' : ''  }}"><a href="{{ url(ADMIN_URL.'/lives') }}"><i class="fa fa-home"></i><span>Manage Lives in the House</span></a></li>
        @endif
