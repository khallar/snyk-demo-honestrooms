        ...
        <div class="col-md-8 col-sm-offset-2">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Lives in the House Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => ADMIN_URL.'/edit_lives/'.$result->id, 'class' => 'form-horizontal','id'=>'form']) !!}
              <div class="box-body">
...
{!! Html::script('js/jquery-1.11.3.js') !!}
    ...
    $(document).ready(function() {
      $('#input_status').change(function(){
        ...
        $.ajax({
          type: "post",
          url: '{{ url("/") }}/'+ADMIN_URL+'/lives_status_check/'+status_id,
