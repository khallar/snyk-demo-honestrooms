...
<em>{{ trans('messages.lys.location_desc2_pre') }}</em>
...
<div class="not-post-listed row row-space-top-6 progress-buttons">
  ...
  <div class="col-10 text-right next_step">
      ...
      <a data-prevent-default="" href="{{ url('manage-listing/'.$room_id.'/services') }}" class="btn btn-large btn-primary next-section-button">
