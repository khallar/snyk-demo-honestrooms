  ...
  <div class="manage-listing-content-wrapper">
    <div id="js-manage-listing-content" class="manage-listing-content col-lg-7 col-md-7">
      <div>
        ...
        <hr>
        <div id="help-panel-monthly-price" class="js-section">
          ...
          <label for="listing_price_native" class="label-large">{{ trans('messages.lys.monthly_price') }}
          </label>
          <div class="row">
            <div class="col-md-6 col-sm-10 pricing_field_list">
              <div class="input-addon price_field">
                ...
                <input type="number" min="0" limit-to=9 data-suggested="" id="price-month" value="{{ ($result->rooms_price->original_month == 0) ? '' : $result->rooms_price->original_month }}" name="month" class="input-stem input-large autosubmit-text" data-saving="base_price">
                <input type="hidden" id="price-month-old" value="{{ ($result->rooms_price->original_month == 0) ? '' : $result->rooms_price->original_month }}" name="month_old" class="input-stem input-large autosubmit-text">
              </div>
            </div>
          ...
          <h4>{{ trans('messages.service_host_rule.include_service') }}</h4>
          <p>{{ trans('messages.service_host_rule.include_service_desc') }}</p>
        ...
        <input type="checkbox" value="{{$service_val->id}}" name="service" data-saving="{{ $service_val->id }}" {{ in_array($service_val->id,$prev_service) ? 'checked' : '' }}>
        <span>{{ $service_val->name }}</span>
      ...
      <div class="manage-listing-help-panel-wrapper">
        <div class="panel manage-listing-help-panel" >
          ...
          <div class="panel-body">
            <h4 class="text-center">{{ trans('messages.lys.monthly_price') }}
            </h4>
