...
<!-- Center Part Starting  -->
  <div class="manage-listing-row-container">
   ...
   <div id="ajax_container" class="col-lg-10 col-md-9 mar-left-cont lang-left" ng-init="saving_text = '{{trans('messages.lys.saving').'...'}}'; saved_text='{{trans('messages.lys.saved').'!'}}';status='{{$result->status}}';steps_count={{$result->rooms_price->steps_count}}; rooms_default_description = {{json_encode(['name' => $result->name, 'summary' => $result->summary])}}">
