...
<div class="js-section"ng-init="bedrooms='{{ $result->bedrooms }}';beds='{{ $result->beds }}';bathrooms='{{ $result->bathrooms }}';bed_type='{{ $result->bed_type }}';">
  ...
  <select name="beds" id="basics-select-beds" data-saving="basics1" ng-model="beds">
    ...
    <!-- Changes Bath rooms customization at 08/02/2019 -->
<!--     <div id="js-bathrooms_select-container" class="col-4">
  ...
  <select name="bathrooms" id="basics-select-bathrooms" data-saving="basics1" ng-model="bathrooms">
   ...
   {{--- <div class="col-4" id="beds_show" style="{{ (!$result->beds) ? 'display:none;' : '' }}">
...
<hr class="row-space-top-1 row-space-3">
...
<div class="js-section">
  ...
  <h5>{{ trans('messages.lys.select') }}...</h5>
    ...
    @foreach($amenities_type as $row_type)
        @if($row_type->original_name === 'Room Amenities')
        <div>
            <div class="js-section">
                ...
                <h5>{{$row_type->name}}</h5>
                <p>{!! trans('messages.lys.room_ameneties_desc_2') !!}</p>
  ...
  <div class="row">
    ...
    <div class="col-4">
        ...
        <div id="person-capacity-select"><div class="select select-large select-block">
...
<div class="not-post-listed row row-space-top-4 progress-buttons">
  <div class="col-12">
...
<div class="manage-listing-help col-lg-4 col-md-4 hide-sm" id="js-manage-listing-help">
  <div class="manage-listing-help-panel-wrapper">
    <div class="panel manage-listing-help-panel">
      ...
      <div class="panel-body">
        <h4 class="text-center">{{ trans('messages.header.room_title') }}</h4>
        <p>{{ trans('messages.lys.room_title_desc') }}</p>
      </div>
    </div>
  </div>
  <div class="manage-listing-help-panel-wrapper">
    <div class="panel manage-listing-help-panel">
      ...
      <div class="panel-body">
        <p>{{ trans('messages.lys.room_title_2_desc') }}</p>
      </div>
    </div>
  </div>
</div>
