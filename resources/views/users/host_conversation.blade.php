      ...
      <div class="row">
        <div class="col-md-8 lang-chang-label">
          <div class="h4">
            ...
            <br>
            <small>
              {{ $messages[0]->reservation->dates }} ({{ $messages[0]->reservation->nights }} {{ trans_choice('messages.service_host_rule.month',1) }}{{ ($messages[0]->reservation->nights > 1) ? 's' : '' }})
              ·
            ...
            <ul class="list-unstyled action-list hide">
              ...
              <li data-key="special_offer" class="action-list-item template_2 row-space-top-1">
                ...
                <label class="action-label">
                 ...
                 <input readonly="readonly" type="hidden" ng-model="available_date" ng-init="available_date = '{{$messages[0]->reservation->rooms->available_date == '0000-00-00' ? '' : $messages[0]->reservation->rooms->available_date_mdy }}';">
